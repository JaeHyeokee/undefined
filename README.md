...
| 메인 페이지 | 메인 페이지 |
| :-------------------------------------------: | :-------------------------------------------: |
| <img width="400" alt="메인 페이지" src="https://i.postimg.cc/hPLR8TzK/image.png"/> | <img width="400" alt="숙박 예약" src="https://i.postimg.cc/hPLR8TzK/image.png"/> |
| 사용자는 메인 페이지에서 숙박 예약, 승차권 조회를 위해 해당 페이지에 접근할 수 있습니다. 또한, 숙소의 테마별 실시간 랭킹을 확인할 수 있습니다. | 사용자는 메인 페이지에서 숙박 예약, 승차권 조회를 위해 해당 페이지에 접근할 수 있습니다. 또한, 숙소의 테마별 실시간 랭킹을 확인할 수 있습니다. |
